...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    this is CTUniversalModel
                   DESC

  s.homepage     = "https://github.com/casatwy/CTUniversalModel"
  ...
  s.source       = { :git => "https://github.com/casatwy/CTUniversalModel.git", :tag => s.version.to_s }
  ...
  # s.ios.resource  = "CTUniversalModel/CTUniversalModel/CTUniversalModel.js"
